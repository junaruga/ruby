...
# %patch 9 -p1
cat ruby-3.3.0-Disable-syntax-suggest-test-case.patch | patch -p1

# %patch 12 -p1
cat ruby-3.4.0-Extract-hardening-CFLAGS-to-a-special-hardenflags-variable.patch | patch -p1

# %patch 13 -p1
cat ruby-3.4.0-openssl-respect-crypto-policies-tls-min.patch | patch -p1

# %patch 15 -p1
# cat ruby-3.4.0-openssl-fix-test-provider-in-fips.patch | patch -p1

# %patch 16 -p1
# cat ruby-3.4.2-openssl-Fix-SHA-1-PSS-tests.patch | patch -p1
